...
export default function StudentAttendance() {
    ...
    return (
        <motion.div variants={container} initial="hidden" animate="show" className="space-y-10 pb-32">
            ...
            <motion.header variants={item} className="relative z-30 flex flex-col md:flex-row md:items-end justify-between gap-10">
                ...
                <div className="w-full md:w-72 bg-white p-2 rounded-2xl shadow-xl shadow-slate-100/50 border border-slate-100 overflow-visible transition-all">
                    <PremiumSelect
                        label="Semester"
            ...
            <motion.div variants={item} className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="aether-card p-8 group overflow-visible">
                    <div className="w-10 h-10 bg-red-50 rounded-xl flex items-center justify-center mb-8 border border-red-100 group-hover:bg-[#E31E24] group-hover:text-white transition-all duration-500">
                ...
                <div className="aether-card p-8 group overflow-visible">
                    <div className="w-10 h-10 bg-emerald-50 rounded-xl flex items-center justify-center mb-8 border border-emerald-100 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-500">
                ...
                <div className="aether-card p-8 group overflow-visible">
                    <div className="w-10 h-10 bg-rose-50 rounded-xl flex items-center justify-center mb-8 border border-rose-100 group-hover:bg-rose-500 group-hover:text-white transition-all duration-500">
                ...
                <div className="aether-card p-8 group overflow-visible">
                    <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center mb-8 border border-slate-100 group-hover:bg-slate-900 group-hover:text-white transition-all duration-500">
            ...
            <motion.div variants={item} className="aether-card max-w-5xl shadow-2xl shadow-slate-200/40">
                <div className="flex flex-col sm:flex-row justify-between items-center p-10 border-b border-slate-50 gap-6">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 bg-red-50 rounded-[1.1rem] border border-red-100 flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-4 bg-slate-50 p-2 rounded-2xl border border-slate-100">
                        <button onClick={() => setSelectedMonth(p => new Date(p.getFullYear(), p.getMonth() - 1))} className="w-10 h-10 flex items-center justify-center rounded-xl bg-white text-slate-900 shadow-sm hover:bg-[#E31E24] hover:text-white transition-all">
